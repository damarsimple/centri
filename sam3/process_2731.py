...
for i in range(num_chunks):
    ...
    print(f"Starting chunk {i}: {s_f} to {s_f+n_f}")
    f = open(out_file, "w")
...
with open("results_2731.json", "w") as f:
    json.dump(merged, f)
...
subprocess.run([
    ...
    "--video", video,
    "--json", "results_2731.json",
    "--output", "output_2731_trail.mp4"
])
print("Done! output_2731_trail.mp4")
