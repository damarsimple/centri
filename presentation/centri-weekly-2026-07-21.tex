...
% =========================================================================
\begin{frame}{What Centri produces}
\small
...
% =========================================================================
\begin{frame}{Correcting the camera angle}
\scriptsize
...
% =========================================================================
\begin{frame}{Verifying each measurement}
\small
...
% =========================================================================
\begin{frame}{What the learner receives}
\scriptsize
...
% =========================================================================
\begin{frame}{The accuracy limit: the marker}
\small
...
% =========================================================================
\begin{frame}{Catching an impossible number}
\small
...
% =========================================================================
\begin{frame}{Planned: ceiling fan with sensors}
\small
...
% =========================================================================
\begin{frame}{Also planned; open decisions}
\small
\begin{columns}[T]
