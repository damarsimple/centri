...
drawing of it.
\end{tcolorbox}
\takeaway{The three slides that follow are those three claims, each with the evidence that supports it.}
\end{frame}
...
--- the average turn rate moves 0.1\%.}
\end{frame}
...
found faults that had already passed a full review and reached a previous deck.}
\end{frame}
