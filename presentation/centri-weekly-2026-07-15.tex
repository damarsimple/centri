...
\bottomrule
\end{tabular}
\takeaway{None of these is a ``small model'' problem --- they were data / figure / wording defects that
would mislead any model, GPT-4o included. Fixing them is what makes ``video $\to$ correct material'' true.}
\end{frame}
...
\end{column}
\end{columns}
\takeaway{Centri already goes beyond the sibling app here: three measured difficulty levels, an
honesty box, and the automatic checklist --- none of which P-MAGIC has.}
\end{frame}
