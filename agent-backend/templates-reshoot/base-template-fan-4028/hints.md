# Processing hints — base-template-fan-4028
...
Observed on a real run of the sibling clip (`job_fan-4027-r2`). Take the median bbox side
as-is; change neither number.
